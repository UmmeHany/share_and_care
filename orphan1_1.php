...
$sql = "select name,location,number from user where lower(owner)='orphanage' ";
...
if(isset($_POST['submit']))
{
 ...
 $sql1="select name,location,number from user where lower(owner)='orphanage' and name='$name1' ";
	...
	<div class="total">
		<div class="header">
			<div class="header-bot">
				<div class="logo">
					<h1 class="style1">&#2437&#2472&#2494&#2469&#2494&#2486&#2509&#2480&#2478 &#2468&#2469&#2509&#2479</h1>
				</div>
			...
			<form  method="post" action="orphan1_1.php" >
		...
		?>
             ...
             <ul class="list-1 top-1 bot-2">
				...
				<div class="col_1_of_4 span_1_of_4">
					<img src="images/pic4.jpg" height=215 alt=""/>
				...
				<div class="col_1_of_4 span_1_of_4">
					<img src="images/pic5.jpg" height=215 alt=""/>
						<div class="item_content">
 							<h6 class="item_title">
				...
				<div class="col_1_of_4 span_1_of_4">
					<img src="images/pic6.jpg" height=215 alt=""/>
						<div class="item_content">
 							<h6 class="item_title">
				...
				<div class="col_1_of_4 span_1_of_4">
					<img src="images/pic7.jpg" height=215 alt=""/>
						<div class="item_content">
 							<h6 class="item_title">
